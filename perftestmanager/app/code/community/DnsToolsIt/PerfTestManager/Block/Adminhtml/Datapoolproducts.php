<?php
class DnsToolsIt_PerfTestManager_Block_Adminhtml_Datapoolproducts extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    protected $_addButtonLabel = 'Add New Users Scenario';
