 ...
 */
class DnsToolsIt_PerfTestManager_Block_Adminhtml_Datapool_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    {
        parent::__construct();
        $this->setId('perftestmanager_datapool_tabs');
        $this->setDestElementId('datapool_grid');
