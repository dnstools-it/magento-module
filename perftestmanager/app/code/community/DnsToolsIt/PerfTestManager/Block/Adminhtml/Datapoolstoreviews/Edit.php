<?php
class DnsToolsIt_PerfTestManager_Block_Adminhtml_Datapoolstoreviews_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_datapoolproducts';
        $this->_mode = 'edit';
    ...
    public function getHeaderText()
    {
        if (Mage::registry('perftestmanager_data') && Mage::registry('perftestmanager_data')->getId())
        {
            ...
            return Mage::helper('perftestmanager')->__('New Performance Test Datapool Products');
        }
    }
