<?php
class DnsToolsIt_PerfTestManager_Block_Adminhtml_Datapoolorders extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    {
        parent::__construct();
        $this->_controller = 'adminhtml_datapoolorders';
