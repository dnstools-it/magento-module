<?php
class DnsToolsIt_PerfTestManager_Block_Adminhtml_Datapoolstore extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    protected $_addButtonLabel = 'Add New Store Scenario';
